...
import { changeFavoriteShoe } from "../../../redux/slices/favoriteShoesSlice";

import { toast } from "react-toastify";

const ShoesButton = ({ id, isFavorite }) => {
  ...
  return (
    <button
      ...
      className={
        isAdded ? "shoes__item-favorite-btn_added" : "shoes__item-favorite-btn"
      }
    >
      {isAdded ? (
