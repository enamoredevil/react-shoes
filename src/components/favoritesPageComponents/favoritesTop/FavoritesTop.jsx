...
import "./favoritesTop.scss";

const FavoritesTop = () => {
  return (
    <div className="favorites__top">
      <div>
        <div className="favorites__top-title">
          <h1>Favorites</h1>
          <svg width="30" height="30" viewBox="0 0 16 14" fill="none">
            <path
              ...
              fill="url(#paint0_linear_60_1001)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_60_1001"
                x1="8"
                y1="0"
                x2="8"
                y2="14"
